              ...
              <div className="grid gap-y-6 sm:grid-cols-10 sm:gap-x-5 sm:gap-y-0 md:items-center md:gap-x-8 lg:gap-x-12">
                <div className="sm:col-span-5">
                  <div className="mb-4 md:mb-6">
                    <div className="flex flex-wrap gap-3 text-xs uppercase tracking-wider text-gray-700 md:gap-5 lg:gap-6">
                  ...
                  <p className="mt-4 text-gray-700 md:mt-5">
                    {post.summary}
                  </p>
                  ...
                  <div className="mt-6 flex items-center space-x-2 md:mt-8">
                    <a
                      href={post.url}
                      target="_blank"
                      className="inline-flex items-center font-semibold text-gray-900 hover:underline md:text-base"
                    >
                      <span>Read more</span>
