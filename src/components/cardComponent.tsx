  ...
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-white dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
        ...
        >
          Make every rupee count towards a healthier planet.
        </CardItem>
        <CardItem
          translateZ="100"
          rotateX={20}
        ...
        <div className="flex justify-between items-center mt-20">
          <CardItem
            ...
            translateX={-40}
            as="button"
            className="px-4 py-2 rounded-xl text-xs font-normal text-black hover:bg-gray-100 transition-colors cursor-pointer"
